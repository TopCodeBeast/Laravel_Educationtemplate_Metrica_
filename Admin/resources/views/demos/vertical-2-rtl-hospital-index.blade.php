@extends('layouts.demos.vertical-2-rtl-hospital-master')
...
@section('headerStyle')
    <!-- DataTables -->
        ...
        <link href="{{ URL::asset('assets/datatables/buttons.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- Responsive datatable examples -->
        <link href="{{ URL::asset('assets/datatables/responsive.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />     
@stop
...
@section('dynamicMenu')
    <li class="leftbar-menu-item">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="/demos/vertical-2-rtl-hospital-index"><i class="ti-control-record"></i>Hospital</a></li> 
