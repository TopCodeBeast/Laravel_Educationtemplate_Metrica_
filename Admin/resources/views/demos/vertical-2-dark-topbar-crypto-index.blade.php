@extends('layouts.demos.vertical-2-dark-topbar-crypto-master')
...
@section('dynamicMenu')
 <li class="leftbar-menu-item">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="/demos/vertical-2-dark-topbar-crypto-index"><i class="ti-control-record"></i>Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crypto/crypto-exchange"><i class="ti-control-record"></i>Exchange</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crypto/crypto-wallet"><i class="ti-control-record"></i>Wallet</a></li> 
                        <li class="nav-item"><a class="nav-link" href="/crypto/crypto-news"><i class="ti-control-record"></i>Crypto News</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crypto/crypto-ico"><i class="ti-control-record"></i>ICO List</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crypto/crypto-settings"><i class="ti-control-record"></i>settings</a></li> 
                    </ul>
                </li>
