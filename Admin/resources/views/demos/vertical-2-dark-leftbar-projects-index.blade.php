@extends('layouts.demos.vertical-2-dark-leftbar-projects-master')
...
@section('dynamicMenu')
                <li class="leftbar-menu-item">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="/demos/vertical-2-dark-leftbar-projects-index"><i class="ti-control-record"></i>Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-clients"><i class="ti-control-record"></i>Clients</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-team"><i class="ti-control-record"></i>Team</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-project"><i class="ti-control-record"></i>Project</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-task"><i class="ti-control-record"></i>Task</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-kanban-board"><i class="ti-control-record"></i>Kanban Board</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-chat"><i class="ti-control-record"></i>Chat</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-users"><i class="ti-control-record"></i>Users</a></li>
                        <li class="nav-item"><a class="nav-link" href="/projects/projects-create"><i class="ti-control-record"></i>Project Create</a></li>
                    </ul>
                </li>
