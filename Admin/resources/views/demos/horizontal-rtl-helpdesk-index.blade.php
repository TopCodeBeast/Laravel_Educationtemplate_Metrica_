@extends('layouts.demos.horizontal-rtl-helpdesk-master')

@section('title', 'Metrica - Admin & Dashboard Template')

@section('dynamicNavbar')
<li class="has-submenu">
                 <a href="#">
                                <i data-feather="headphones" class="align-self-center icon-sm icon-dual-hori-nav mr-1"></i>
                                <span>Helpdesk</span>
                            </a>
                            <ul class="submenu">
                                <li><a href="/demos/horizontal-rtl-helpdesk-index"><i class="dripicons-dot"></i>Dashboard</a></li>
                                <li><a href="/helpdesk/helpdesk-teckets"><i class="dripicons-dot"></i>Tickets</a></li>
                                <li><a href="/helpdesk/helpdesk-reports"><i class="dripicons-dot"></i>Reports</a></li>
                                <li><a href="/helpdesk/helpdesk-agents"><i class="dripicons-dot"></i>Agents</a></li>
                            </ul><!--end submenu-->
                        </li><!--end has-submenu-->
