@extends('layouts.demos.vertical-2-dark-helpdesk-master')
...
<li class="leftbar-menu-item">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="/demos/vertical-2-dark-helpdesk-index"><i class="ti-control-record"></i>Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-teckets"><i class="ti-control-record"></i>Tickets</a></li>
                        <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-reports"><i class="ti-control-record"></i>Reports</a></li>
                        <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-agents"><i class="ti-control-record"></i>Agents</a></li>
                    </ul>
                </li>
@stop
...
@section('footerScript')
 <script src="{{ URL::asset('assets/pages/jquery.helpdesk-dashboard.init.js')}}"></script>
