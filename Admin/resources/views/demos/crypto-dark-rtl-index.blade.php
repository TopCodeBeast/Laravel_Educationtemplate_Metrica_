@extends('layouts.demos.crypto-dark-rtl')

@section('title', 'Metrica - Admin & Dashboard Template')


@section('leftarTabPortion')
 <a href="#MetricaCrypto" class="nav-link" data-toggle="tooltip-custom"  data-placement="right" data-trigger="hover" title="" data-original-title="Crypto">
...
@section('sidebarPortion')
    <div id="MetricaCrypto" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="/demos/crypto-dark-rtl-index">Dashboard</a></li>
