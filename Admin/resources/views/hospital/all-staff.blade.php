   ...
   <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <button type="button" class="btn btn-gradient-primary px-4 mt-0 mb-3" onclick="location.href='../hospital/add-member'"><i class="mdi mdi-plus-circle-outline mr-2"></i>Add New Member</button>
                                    <div class="table-responsive">
                                        <table id="datatable" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>Nurse</td>                                                                                               
                                                <td class="text-right">                                                       
                                                    <a href="/hospital/edit-member" class="mr-2"><i class="fas fa-edit text-info font-16"></i></a>
