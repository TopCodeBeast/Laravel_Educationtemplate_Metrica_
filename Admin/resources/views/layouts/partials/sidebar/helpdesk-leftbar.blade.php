 <!-- leftbar-tab-menu -->
        <div class="leftbar-tab-menu">
            <div class="main-icon-menu">
                <a href="/helpdesk/helpdesk-index" class="logo logo-metrica d-block text-center">
                    <span>
                        <img src="{{ URL::asset('assets/images/logo-sm.png')}}" alt="logo-small" class="logo-sm">
                    </span>
                </a>
                <nav class="nav">
                    <a href="#MetricaHelpdesk" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Helpdesk" data-trigger="hover">
                        <i data-feather="headphones" class="align-self-center menu-icon icon-dual"></i>
                    </a><!--end MetricaHelpdesk-->  
            ...
            <div class="main-menu-inner">
                ...
                <div class="menu-body slimscroll">                    
                    <div id="MetricaHelpdesk" class="main-icon-menu-pane">
                        <div class="title-box">
                            <h6 class="menu-title">Helpdesk</h6>       
                        </div>
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-index">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-teckets">Tickets</a></li>
                            <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-reports">Reports</a></li>
                            <li class="nav-item"><a class="nav-link" href="/helpdesk/helpdesk-agents">Agents</a></li>
                        </ul>
                    </div><!-- end Helpdesk -->       
