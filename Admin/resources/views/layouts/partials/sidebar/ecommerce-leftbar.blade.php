        ...
        <div class="leftbar-tab-menu">
            ...
            <div class="main-menu-inner">
                ...
                <div class="topbar-left">
                    <a href="/ecommerce/ecommerce-index" class="logo">
                        <span>
                ...
                <div class="menu-body slimscroll">                    
                    <div id="MetricaEcommerce" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-index">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-products">Products</a></li>
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-product-list">Product List</a></li>
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-product-detail">Product Detail</a></li>
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-cart">Cart</a></li>
                            <li class="nav-item"><a class="nav-link" href="../ecommerce/ecommerce-checkout">Checkout</a></li>
                        </ul>
                    </div><!-- end Ecommerce -->
