  <div class="leftbar-tab-menu">
            <div class="main-icon-menu">
                <a href="/crypto/crypto-index" class="logo logo-metrica d-block text-center">
                    <span>
                        <img src="{{ URL::asset('assets/images/logo-sm.png')}}" alt="logo-small" class="logo-sm">
                    </span>
                </a>
                <nav class="nav">
                    <a href="#MetricaCrypto" class="nav-link" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Crypto" data-trigger="hover">
            ...
            <div class="main-menu-inner">
                ...
                <div class="topbar-left">
                    <a href="/crypto/crypto-index" class="logo">
                        <span>
                ...
                <div class="menu-body slimscroll">                    
                    <div id="MetricaCrypto" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-index">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-exchange">Exchange</a></li>
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-wallet">Wallet</a></li> 
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-news">Crypto News</a></li>
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-ico">ICO List</a></li>
                            <li class="nav-item"><a class="nav-link" href="/crypto/crypto-settings">settings</a></li> 
                        </ul>
                    </div><!-- end Crypto -->
