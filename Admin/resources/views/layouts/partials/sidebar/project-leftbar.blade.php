 <!-- leftbar-tab-menu -->
        <div class="leftbar-tab-menu">
            <div class="main-icon-menu">
                <a href="/projects/projects-index" class="logo logo-metrica d-block text-center">
                    <span>
            ...
            <div class="main-menu-inner">
                ...
                <div class="topbar-left">
                    <a href="/projects/projects-index" class="logo">
                        <span>
                ...
                <div class="menu-body slimscroll">                    
                    <div id="MetricaProject" class="main-icon-menu-pane">
                        ...
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-index">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-clients">Clients</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-team">Team</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-project">Project</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-task">Task</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-kanban-board">Kanban Board</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-chat">Chat</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-users">Users</a></li>
                            <li class="nav-item"><a class="nav-link" href="/projects/projects-create">Project Create</a></li>
                        </ul>
                    </div><!-- end Project -->     
