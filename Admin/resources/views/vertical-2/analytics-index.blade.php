...
@section('sidebarPortion')
 <li class="leftbar-menu-item">
                    <a href="javascript: void(0);" class="menu-link">
                        <i data-feather="bar-chart-2" class="align-self-center vertical-menu-icon icon-dual-vertical"></i>
                        <span>Dashboard</span>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/analytics/analytics-customers"><i class="ti-control-record"></i>Customers</a></li>
                        <li class="nav-item"><a class="nav-link" href="/analytics/analytics-reports"><i class="ti-control-record"></i>Reports</a></li>
                    </ul>
                </li>
@stop
...
@section('footerScript')
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                document.body.classList.add('dark-topbar');
            });
        </script>
