...
@section('sidebarPortion')
 <li class="leftbar-menu-item">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="/vertical-2/crm-index"><i class="ti-control-record"></i>Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crm/crm-contacts"><i class="ti-control-record"></i>Contacts</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crm/crm-opportunities"><i class="ti-control-record"></i>Opportunities</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crm/crm-leads"><i class="ti-control-record"></i>Leads</a></li>
                        <li class="nav-item"><a class="nav-link" href="/crm/crm-customers"><i class="ti-control-record"></i>Customers</a></li>
                    </ul>
                </li>
@stop
