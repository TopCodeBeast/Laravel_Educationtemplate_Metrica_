                                ...
                                <div class="tab-content chat-list slimscroll" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="group_chat">                                                
                                        <a href="" class="media new-message">
                                            <div class="media-left">
                                                <div class="avatar-box thumb-md align-self-center mr-2">
                                                    <span class="avatar-title bg-primary rounded-circle"><i class="fab fa-quinscape font-20"></i></span>
                                                </div>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
                                        ...
                                        <a href="" class="media">
                                            <div class="media-left">
                                                <div class="avatar-box thumb-md align-self-center mr-2">
                                                    <span class="avatar-title bg-success rounded-circle"><i class="fab fa-connectdevelop font-20"></i></span>
                                                </div>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
                                        ...
                                        <a href="" class="media">
                                            <div class="media-left">
                                                <div class="avatar-box thumb-md align-self-center mr-2">
                                                    <span class="avatar-title bg-warning rounded-circle"><i class="far fa-gem font-20"></i></span>
                                                </div>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
                                        ...
                                        <a href="" class="media">
                                            <div class="media-left">
                                                <div class="avatar-box thumb-md align-self-center mr-2">
                                                    <span class="avatar-title bg-pink rounded-circle"><i class="fab fa-react font-20"></i></span>
                                                </div>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
                                        ...
                                        <a href="" class="media">
                                            <div class="media-left">
                                                <div class="avatar-box thumb-md align-self-center mr-2">
                                                    <span class="avatar-title bg-info rounded-circle"><i class="fas fa-globe font-20"></i></span>
                                                </div>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
