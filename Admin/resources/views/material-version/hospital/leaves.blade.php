                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table">
                                            ...
                                            <tr>
                                                <td><a href="/material-version/hospital/member-profile"><img src="{{ URL::asset('assets/images/users/user-9.jpg')}}" alt="" class="thumb-sm rounded-circle mr-2">Keith Jacobson</a></td>
                                                <td>Security</td>
                                                <td>1/7/2019</td>
                                                <td>3/7/2019</td>
                                                <td>3</td>
                                            ...
                                            <tr>
                                                <td><a href="/material-version/hospital/member-profile"><img src="{{ URL::asset('assets/images/users/user-9.jpg')}}" alt="" class="thumb-sm rounded-circle mr-2">Greg Crosby</a></td>
                                                <td>Pharmacist</td>
                                                <td>24/6/2019</td>
                                                <td>24/6/2019</td>
                                                <td>1</td>
                                            ...
                                            <tr>
                                                <td><a href="/material-version/hospital/member-profile"><img src="{{ URL::asset('assets/images/users/user-8.jpg')}}" alt="" class="thumb-sm rounded-circle mr-2">Fred Godina</a></td>
                                                <td>Accountant</td>
                                                <td>11/6/2019</td>
                                                <td>14/6/2019</td>
                                                <td>4</td>
                                            ...
                                            <tr>
                                                <td><a href="/material-version/hospital/member-profile"><img src="{{ URL::asset('assets/images/users/user-7.jpg')}}" alt="" class="thumb-sm rounded-circle mr-2">Peggy Doe</a></td>
                                                <td>Nurse</td>
                                                <td>10/7/2019</td>
                                                <td>12/7/2019</td>
                                                <td>3</td>
                                            ...
                                            <tr>
                                                <td><a href="/material-version/hospital/member-profile"><img src="{{ URL::asset('assets/images/users/user-8.jpg')}}" alt="" class="thumb-sm rounded-circle mr-2">Jennifer Doss</a></td>
                                                <td>Doctor</td>
                                                <td>8/7/2019</td>
                                                <td>9/7/2019</td>
                                                <td>2</td>
