                            ...
                            <div class="chat-box-left">
                                ...
                                <div class="tab-content chat-list slimscroll" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="general_chat">
                                        ...
                                        <a href="" class="media">
                                            <div class="media-left">
                                                <img src="{{ URL::asset('assets/images/users/dr-4.jpg')}}" alt="user" class="rounded-circle thumb-md">
                                                <span class="round-10 bg-danger"></span>
                                            </div><!-- media-left -->
                                            <div class="media-body">
                                                <div>
                                ...
                                <div class="chat-footer">
                                    <div class="row">                                                    
                                        <div class="col-12 col-md-9">
                                            <span class="chat-admin"><img src="{{ URL::asset('assets/images/users/dr-3.jpg')}}" alt="user" class="rounded-circle thumb-sm"></span>
