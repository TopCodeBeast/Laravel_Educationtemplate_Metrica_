            ...
            <div class="auth-page">
                <div class="card mb-0 shadow-none h-100">
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            <a href="/material-version/analytics/analytics-index" class="logo logo-admin">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane p-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    <div class="mx-3 mt-3 text-center bg-light p-3 text-primary">
                                        ...
                                        <a href="/material-version/authentication/auth-register-alt" class="btn btn-primary waves-effect waves-light">Free Resister</a>
                                    </div>
                                ...
                                <div class="tab-pane active px-3 pt-3" id="Register_Tab" role="tabpanel">
                                    ...
                                    <div class="mx-3 mt-3 mb-0 text-center text-muted">
                                        <p class="mb-0">Already have an account ? <a href="/material-version/authentication/auth-login-alt" class="text-primary ml-2">Log in</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
